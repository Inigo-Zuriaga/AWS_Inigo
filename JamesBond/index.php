...
<?php foreach ($_SESSION['personajes'] as $key => $row) { ?>
    <ul>
        ...
        <li><input type="text" name="Título" value="<?php echo $row['Título'] ?>"/></li>
        <li><input type="text"  name="JB" value="<?php echo $row['James Bond']?>"/></li>
        <li><input type="text"  name="Director" value="<?php echo $row['Director'] ?>"></li>
        <li><input type="number" name="Nota" value="<?php echo $row['Nota Rottentomatoes'] ?>"/></li>
        <li><input type="number" name="Anio" value="<?php echo $row['Año']?>"/></li>
        <li>
